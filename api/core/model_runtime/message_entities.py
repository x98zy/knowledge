...
class PromptMessageRule(StrEnum):
    SYSTEM = auto()
    USER = auto()
    ASSISTANT = auto()
    TOOL = auto()
    ...
    @classmethod
    def value_of(cls, value: str) -> "PromptMessageRule":
        for member in cls:
...
class UserPromptMessage(PromptMessage):
    ...
    rule: PromptMessageRule = PromptMessageRule.USER
...
class AssistantPromptMessage(PromptMessage):
    ...
    rule: PromptMessageRule = PromptMessageRule.ASSISTANT
    ...
    def is_empty(self) -> bool:
        ...
        :return: True if prompt message is empty, False otherwise
        """
        if not super().is_empty() and not self.tool_calls:  # noqa: SIM103
            return False
...
class SystemPromptMessage(PromptMessage):
    ...
    rule: PromptMessageRule = PromptMessageRule.SYSTEM
...
class ToolPromptMessage(PromptMessage):
    ...
    rule: PromptMessageRule = PromptMessageRule.TOOL
    tool_call_id: str
    ...
    def is_empty(self) -> bool:
        ...
        :return: True if prompt message is empty, False otherwise
        """
        if not super().is_empty() and not self.tool_call_id:  # noqa: SIM103
            return False
