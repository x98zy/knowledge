...
from core.model_manager import ModelInstance  # noqa: TC001
...
class EnhanceRecursiveCharacterTextSplitter(RecursiveCharacterTextSplitter):
    ...
    def from_encoder(
        ...
        allowed_special: Literal["all"] | Set[str] = set(),  # noqa: UP037
        disallowed_special: Literal["all"] | Collection[str] = "all",  # noqa: UP037
        **kwargs: Any,
    ):
...
class FixedRecursiveCharacterTextSplitter(EnhanceRecursiveCharacterTextSplitter):
    ...
    def split_text(self, text: str) -> list[str]:
        ...
        if self._fixed_separator:  # noqa: SIM108
        ...
        for chunk, chunk_length in zip(chunks, chunks_lengths):  # noqa: B905
    ...
    def recursive_split_text(self, text: str) -> list[str]:
        ...
        if separator != "":
            for s, s_len in zip(splits, s_lens):  # noqa: B905
